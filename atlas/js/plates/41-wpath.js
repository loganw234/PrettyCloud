...
Atlas.registerPlate({
  ...
  caption: "In 1872 Weierstrass presented the Berlin Academy with a function continuous everywhere yet differentiable nowhere. Depth is truncation N: the back wall is one cosine; each slice forward adds a term, and roughness arrives scale by scale until the front face is the monster itself. Brightness is the graph's occupation measure: steep strokes spread their points thin and burn faintest. Colour tracks the newest term, the latest wrinkle aglow. Once ab > 1 the graph has box dimension 2 + log a/log b, steered by AMPLITUDE and FREQ; FUNCTION swaps in Takagi's blancmange (1903) or Riemann's sum sin(πn²x)/πn², differentiable, Gerver proved, exactly at rationals with odd numerator and denominator in lowest terms; ZOOM descends into self-affine detail.",
