...
Atlas.registerPlate({
  ...
  roman: "LXII",
  accent: "#e08fb8",
  tex: "\\varepsilon_{n+1} = \\varepsilon_n \\cdot W,\\quad \\langle W\\rangle = 1,\\ \\operatorname{Var}\\log W = \\lambda^2",
  plain: "ε ← ε · W per octave,  ⟨W⟩ = 1,  Var(log W) = λ²   (multiplicative cascade)",
