...
PAGES["index.html"] = dict(
    ...
    desc="A film camera for things that have never existed, with real "
         "glass in front of it. Sixty-four mathematical objects, "
...
<div class="prose">
<p>The subjects are mathematical objects: sixty-four of them, each a few
...
<div class="cols">
  <div>
    ...
    <p>The atlas runs in a browser. Sixty-four objects, drawn a million
